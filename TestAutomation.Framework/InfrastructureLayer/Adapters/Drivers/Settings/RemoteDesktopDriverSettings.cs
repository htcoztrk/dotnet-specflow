...
namespace TestAutomation.Framework.InfrastructureLayer.Adapters.Drivers.Settings {
    class RemoteDesktopDriverSettings : IDesktopDriverSettings {

        private readonly ProxyServer proxyServer;

        public RemoteDesktopDriverSettings(ProxyServer proxyServer) {
        ...
        public Uri WinAppDriverHubUri
        {
            get
            {
                return new Uri(Config.GetInstance().WinAppDriverUri);
            }
        }
