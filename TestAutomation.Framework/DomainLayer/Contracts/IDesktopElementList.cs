...
namespace TestAutomation.Framework.DomainLayer.Contracts {
    [ElementType]
    public interface IDesktopElementList : IEnumerable {
        /// <summary>
        /// Elementi verilen index altında bulunduğunda IDesktopElement tipinde dönüş yapar
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
        IDesktopElement this[int index] { get; }
